...
const MobileVideo = ({ data }) => {
  ...
  return (
    <div className="relative min-h-screen remove-scrollbar min-w-screen snap-center">
      <video
        loop
      ...
      <button
        className="absolute z-[2] bottom-40 right-2"
        onClick={() => onVideoPress()}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <button
        className="absolute z-[2] bottom-60 right-2"
        onClick={() => onVideoPress()}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <button
        className="absolute z-[2] bottom-80 right-2 hover:brightness-125"
        onClick={() => onVideoPress()}
      >
        <Image
        ...
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="absolute h-5 w-5 z-[3] bottom-0 right-3 fill-current text-maximum-red "
          viewBox="0 0 20 20"
          fill="currentColor"
        >
          <path
      ...
      <div
        className={`${
          data.userLaughedAt || "" ? "text-maximum-red" : "text-black"
        } absolute z-[2] bottom-20 right-2 rounded-full bg-lemon-meringue animate-wiggle`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 64 64"
          enable-background="new 0 0 64 64"
          className="relative w-12 h-12 fill-current"
        >
